<x-default-layout title="Daftar Ulasan" section_title="Daftar Ulasan">
    <section class="container mx-auto px-4 py-10">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-orange-600 mb-4">Daftar Ulasan</h2>
            <div class="mb-6">
                <a href="{{ route('review.create') }}" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded">Tambah Ulasan</a>
            </div>
        </div>
        <div class="space-y-6">
